...
After completing the exploratory data analysis, the focus of the project turned to the generation of the training and testing sets.  Eighty percent of *crude_oil_in_commodites_market* was randomly selected to be in *crude_oil_train*.  The remaining twenty percent was held-back to be *crude_oil_test*.
...
```
#### Algorithm 09 (Ranger - Time, Energy, Precious Metals, Agriculture)
